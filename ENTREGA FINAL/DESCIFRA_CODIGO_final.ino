...
//FUNCIONES
void inicio_juego();						//Te muestra por pantalla y por el lcd INICIO DESCIFRA EL CÓDIGO.
...
void loop() {
	...
	do{
		...
		//Te devuelve el flagfail, si es 0 has ganado y te pone una nueva contraseña, sino entra en el if y tienes dos intentos mas.
	...
	//Si la aciertas el falgfail es 0, sales de este bucle y te pone una nueva contraseña. En cambio si fallas 2 veces más a parte de la primera vez saldras de los dos bucles irás a la función game_over() que significa que has perdido.
